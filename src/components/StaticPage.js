            ...
            <Row>
                <Col widths={['xs', 'sm', 'xxl']} sm={5} xxl={7} className="shadow pb-3 mb-5 bg-light" style={{
                    ...
                    <div className="position-relative" >
                        <Img fluid={props.image} style={{
                            height: '90vh',

                        }} />
                        <h1 className="display-4 font-weight-bold p-4 bg-light text-primary" style={{
                            position: 'absolute',
                            bottom: '2rem',
                            right: 0,
                            zIndex: 50,
                    ...
                    <div className="text-center pt-3 bg-light text-dark d-flex align-items-center justify-content-center justify-content-sm-end">
                        <span className="mr-4"><FormattedMessage id="share" defaultMessage="en" /></span>
                        <div>
                        ...
                        {props.cta ? (
                            <div>
                                ...
                                <div className="text-center pb-3">
                                    <p><FormattedMessage id={props.cta.text} defaultMessage="en" /></p>
                                    <AniLink to={props.cta.link} className="btn btn-primary">
                                        <FormattedMessage id={props.cta.btn_text} defaultMessage="en" />
                                    </AniLink>
                                </div>
                            </div>
                        ) : null}
